 ...
 */
function create_user($conn, $username, $password, $firstname, $surname, $email, $mobile, $date_of_birth)
{
    $sql = "INSERT INTO user_details (username, password, firstname, surname, date_of_birth, email, mobile, date_recorded) VALUES (?, ?, ?, ?, ?, ?, ?, NOW())";
    $stmt = $conn->prepare($sql);
    ...
    $stmt->bind_param("sssssss", $username, $password, $firstname, $surname, $date_of_birth, $email, $mobile);
...
function handle_registration($conn)
{
    ...
    $user_id = create_user($conn, $username, $password_hash, $firstname, $surname, $email, $mobile, $date_of_birth);
